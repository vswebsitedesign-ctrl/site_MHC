...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $clearance_string = !empty($clearance_types) ? implode(", ", $clearance_types) : "None selected";

    if (empty($first_name) || empty($surname) || empty($phone) || empty($postcode)) {
    ...
    $email_body .= "Name: " . $first_name . " " . $surname . "\n";
    $email_body .= "Phone Number: " . $phone . "\n";
    $email_body .= "Email Address: " . ($email ? $email : "Not provided / Invalid") . "\n";
